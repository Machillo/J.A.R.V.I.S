...
const vip = readFileSync(new URL("../src/products/dincr/features/vip/VipScreens.jsx", import.meta.url), "utf8");
const basic = readFileSync(new URL("../src/products/dincr/features/basic/BasicScreens.jsx", import.meta.url), "utf8");
const free = readFileSync(new URL("../src/products/dincr/features/free/FreeScreens.jsx", import.meta.url), "utf8");
const registry = readFileSync(new URL("../src/products/dincr/features/registry.jsx", import.meta.url), "utf8");
const navigation = readFileSync(new URL("../src/products/dincr/navigation/DincrNavigation.jsx", import.meta.url), "utf8");
const hubs = readFileSync(new URL("../src/products/dincr/features/hubs/DincrHubs.jsx", import.meta.url), "utf8");
