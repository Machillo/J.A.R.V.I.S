...
const platforms = [
  ['Android', 'googlePlayUrl', 'Google Play', ['Entrás con tu cuenta de Google.', 'Bloqueo con huella o con el PIN del teléfono.', 'Requiere Android 7.0 o posterior.']],
...
const mark = v => v ? '<span class="yes" role="img" aria-label="Incluido"></span>' : '<span class="muted" role="img" aria-label="No incluido">—</span>';
...
const pages = {
  ...
  '/descargar/': layout('/descargar/', 'Descargar DINCR', `<section class="section page"><div class="wrap"><h1>DINCR para Android y iPhone</h1><p class="section-lead">Una sola cuenta DINCR en los dos sistemas, con la misma información y el mismo plan.</p>${availability}<div class="platforms">${platforms}</div></div></section>`, { noindex: !cfg.googlePlayUrl && !cfg.appStoreUrl }),
};
