const dictionaries = {
  es: {
    ...
    debtTypes: { credit_card: "Tarjeta de crédito", tarjeta: "Tarjeta de crédito", loan: "Préstamo", personal_loan: "Préstamo personal", tasa_cero: "Tasa cero", minicuotas: "Minicuotas", compra_financiada: "Compra financiada", familiar: "Familiar", other: "Otra" },
  ...
  en: {
    ...
    accounts: {
      eyebrow: "EMAIL BANKING", title: "Accounts", intro: "DINCR recognizes the institution from the emails it already processes. Review each transaction before adding it to finance.", add: "Add account", detected: "Detected banks", version: "Banks recognized in your emails", recognizing: "Recognizing banks in your emails...", noneDetected: "I haven’t found emails from recognized banks yet.", detectedByEmail: "Account detected by email", movements: "detected transactions", review: "to review", movement: "Bank transaction", pending: "To review", rejected: "Rejected", duplicate: "Duplicate", inFinance: "In finance", approve: "Approve transaction", reject: "Reject transaction", realBalance: "Recorded real balance", reconcileDifference: "Reconciliation difference", manual: "Manual accounts", manualHelp: "Balances used for net worth and reconciliation", loading: "Loading accounts...", noManual: "There are no manual balances yet. Detected banks above do not invent balances.", hideConfirm: "Hide this financial account?", loadError: "I couldn’t load the accounts.", emailError: "I couldn’t read the bank transactions."
    },
    ...
    debtTypes: { credit_card: "Credit card", tarjeta: "Credit card", loan: "Loan", personal_loan: "Personal loan", tasa_cero: "Zero-interest plan", minicuotas: "Installments", compra_financiada: "Financed purchase", familiar: "Family", other: "Other" },
...
// Shared copy helper so DINCR and DINCR always follow the same device-language rule.
