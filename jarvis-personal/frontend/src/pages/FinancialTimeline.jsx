...
const dateLabel = (value) => new Date(`${value}T12:00:00`).toLocaleDateString(localeTag(language), { day: "numeric", month: "short" });
...
export default function FinancialTimeline() {
  ...
  useEffect(() => { load(); }, []);
  if (state.loading) return <section className="hud-panel">{tx("Calculando liquidez futura...", "Calculating future liquidity...")}</section>;
