...
export default function FinancialTimeline() {
  ...
  return <section className="financial-timeline-page">
    <div className="hud-panel financial-timeline-hero">
      <div><span className="strategy-eyebrow">JARVIS 07 · LIQUIDITY MAP</span><h2>{tx("Timeline financiero", "Financial timeline")}</h2><p>Cómo cambia tu saldo disponible con los ingresos, obligaciones y compromisos conocidos.</p></div>
