...
function PrivacyPage() {
  return <>
    ...
    <section className="public-copy legal-copy">
      ...
      <h2>5. Proveedores y transferencias</h2><p>Para operar el servicio pueden intervenir proveedores de autenticación, base de datos, alojamiento, distribución móvil, monitoreo, correo e inteligencia artificial, incluidos Supabase (autenticación y base de datos), Render (alojamiento), Google (Gmail y, en Android, Firebase Analytics y Crashlytics para métricas de uso y diagnóstico de errores), Microsoft (Outlook) y PostHog (analítica de producto anónima, sin correo, nombre ni datos financieros). Solo reciben la información necesaria para su función y pueden procesarla fuera de Costa Rica bajo sus medidas y condiciones de protección.</p>
      <h2>6. Integraciones de correo (Google y Microsoft)</h2><p>Cuando el usuario conecta Gmail u Outlook, el acceso es de solo lectura y se usa únicamente para detectar mensajes de remitentes financieros compatibles y proponer movimientos que el usuario revisa. DINCR no envía, modifica ni borra correos. El detalle técnico usado para revisar un hallazgo se elimina después de 30 días y los datos identificativos del correo después de 90 días, cuando no haya revisiones pendientes. Al desconectar el correo o eliminar la cuenta, la autorización guardada se borra y, en Gmail, se revoca ante Google. Los datos de Google y Microsoft no se venden ni se utilizan para anuncios. Su uso se ajusta a la <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noreferrer">Política de Datos de Usuario de los Servicios API de Google</a>, incluidos los requisitos de Uso Limitado.</p>
