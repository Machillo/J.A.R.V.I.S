...
function TermsPage() {
  return <>
    ...
    <p className="public-lead">Estos términos regulan el acceso y uso de DINCR y J.A.R.V.I.S., servicios digitales desarrollados y operados desde Costa Rica por Kenneth Andrés Alvarado Obando.</p>
    <section className="public-copy legal-copy">
      ...
      <h2>2. Finalidad del servicio</h2><p>DINCR y J.A.R.V.I.S. ayudan a registrar, organizar, analizar y proyectar información financiera. Sus cálculos, alertas, simulaciones y contenido generado con automatización o inteligencia artificial son orientativos y pueden contener errores.</p>
...
function PrivacyPage() {
  return <>
    ...
    <p className="public-lead">Esta política explica cómo DINCR y J.A.R.V.I.S. tratan datos personales conforme a los principios de consentimiento informado, finalidad, proporcionalidad, calidad, seguridad y confidencialidad.</p>
    <section className="public-copy legal-copy">
      <h2>1. Responsable</h2><p>El responsable del tratamiento es Kenneth Andrés Alvarado Obando, Costa Rica, desarrollador y operador de DINCR y J.A.R.V.I.S. Las solicitudes se reciben mediante Reportes o el canal de soporte mostrado dentro de la aplicación.</p>
