...
function TermsPage() {
  return <>
    <span className="public-kicker">VERSIÓN 2026-09-16-v1 · VIGENTE DESDE EL 16 DE SEPTIEMBRE DE 2026</span>
    <h1>Términos y Condiciones</h1>
    <p className="public-lead">Estos términos regulan el acceso y uso de FINVA y J.A.R.V.I.S., servicios digitales desarrollados y operados desde Costa Rica por Kenneth Andrés Alvarado Obando.</p>
    <section className="public-copy legal-copy">
      ...
      <h2>2. Finalidad del servicio</h2><p>FINVA y J.A.R.V.I.S. ayudan a registrar, organizar, analizar y proyectar información financiera. Sus cálculos, alertas, simulaciones y contenido generado con automatización o inteligencia artificial son orientativos y pueden contener errores.</p>
      ...
      <h2>12. Legislación y contacto</h2><p>Estos términos se interpretan conforme a las leyes de Costa Rica. Las dudas, solicitudes o reclamos pueden enviarse mediante la sección de Reportes o el canal de soporte informado dentro de la aplicación. Se procurará resolver cualquier diferencia de buena fe antes de acudir a las autoridades competentes.</p>
    </section>
  </>;
}
...
function PrivacyPage() {
  return <>
    ...
    <p className="public-lead">Esta política explica cómo FINVA y J.A.R.V.I.S. tratan datos personales conforme a los principios de consentimiento informado, finalidad, proporcionalidad, calidad, seguridad y confidencialidad.</p>
    <section className="public-copy legal-copy">
      <h2>1. Responsable</h2><p>El responsable del tratamiento es Kenneth Andrés Alvarado Obando, Costa Rica, desarrollador y operador de FINVA y J.A.R.V.I.S. Las solicitudes se reciben mediante Reportes o el canal de soporte mostrado dentro de la aplicación.</p>
...
export default function PublicInfoPage() {
  return <main className="public-info-shell">
    <nav className="public-info-nav" aria-label="Información pública"><a className="public-brand" href="/about">FINVA</a><div><a className={!isPrivacy&&!isTerms?"active":""} href="/about">Acerca de</a><a className={isTerms?"active":""} href="/terms">Términos</a><a className={isPrivacy?"active":""} href="/privacy">Privacidad</a></div></nav>
    <div className="public-info-content">{isTerms ? <TermsPage/> : isPrivacy ? <PrivacyPage/> : <AboutPage/>}</div>
    <footer><span>FINVA + J.A.R.V.I.S. · Costa Rica</span><div><a href="/terms">Términos</a> · <a href="/privacy">Privacidad</a></div></footer>
  </main>;
}
