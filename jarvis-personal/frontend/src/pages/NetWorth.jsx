...
export default function NetWorth() {
  ...
  return <section className="net-worth-page jarvis-v2-screen net-worth-v2">
    <div className="net-worth-hero net-worth-v2-hero">
      <div><span className="strategy-eyebrow">DINCR · LIVE WEALTH</span><h2>{tx("Patrimonio neto", "Net worth")}</h2><p>Todo lo que tenés menos todo lo que debés, usando únicamente saldos reales.</p></div>
