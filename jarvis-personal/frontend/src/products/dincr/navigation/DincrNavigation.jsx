...
export default function DincrNavigation({ page, plan, onNavigate, featureFlags }) {
  ...
  return <NativeBottomBar items={items} activeKey={page} onNavigate={onNavigate} className="dincr-native-nav" />;
}
