...
import DincrOverview from "./overview/DincrOverview";
...
import { AdvisorHub, PlanHub, ProfileHub } from "./hubs/DincrHubs";
import FinancialDisclaimer from "../components/FinancialDisclaimer";

export function createDincrFeatureRegistry({ user, plan, navigate, onUserChange, onLogout, featureFlags }) {
  ...
  return {
    overview: plan === "vip" && vipEnabled ? <VipScreens view="dashboard" user={user} onNavigate={navigate} /> : <DincrOverview user={user} plan={plan} onNavigate={navigate} />,
