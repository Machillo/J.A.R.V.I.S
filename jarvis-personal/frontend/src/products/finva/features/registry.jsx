...
export function createFinvaFeatureRegistry({ user, plan, navigate, onUserChange, onLogout, featureFlags }) {
  ...
  return {
    ...
    "vip-aguinaldo": plan === "vip" ? gated("gmail_automation", <VipScreens view="aguinaldo" user={user} onNavigate={navigate} />) : <SettingsPage user={user} onUserChange={onUserChange} onLogout={onLogout} />,
