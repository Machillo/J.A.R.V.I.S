  ...
  return (
    <main className="finva-app-lock finva-app-lock--onboarding" aria-live="polite">
      <section className="finva-app-lock-card finva-app-lock-welcome">
        ...
        {status && !status.isAvailable && <div className="finva-app-lock-error" role="alert">{tx("No encontramos biometría configurada. Podés activarla luego desde Ajustes de DINCR.", "No configured biometrics were found. You can enable it later from DINCR Settings.")}</div>}
