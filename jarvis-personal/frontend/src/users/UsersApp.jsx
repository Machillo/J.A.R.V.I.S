...
import { clearPendingOperations, flushPendingOperations, getPendingOperationCount } from "../lib/operationRecovery";
import "./users.css";
...
export default function UsersApp({ user, onUserChange, releasePolicy }) {
  ...
  const logout = () => { clearPendingOperations(); return supabase.auth.signOut({ scope: "local" }); };
