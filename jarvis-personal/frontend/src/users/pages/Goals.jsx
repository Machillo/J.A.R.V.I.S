...
export default function Goals({ plan = "free", initialView = "goals" }) {
  ...
  const content = !advanced ? freeContent : <section className="content-first-page">
    <div className="hero"><span>{plan === "vip" ? "DINCR · VIP" : advanced ? "BASIC 04" : "FREE 05"}</span><h1>{tx("Metas y ahorros", "Goals and savings")}</h1><p>{tx("Separá lo que querés alcanzar de lo que planeás guardar cada mes.", "Keep your goals separate from what you plan to save each month.")}</p></div>
