...
export default function Transactions({ plan = "free" }) {
  ...
  return <section>
    <div className="hero"><span>DINCR · {PLAN_LABEL[plan] || PLAN_LABEL.free}</span><h1>{tx("Historial", "History")}</h1><p>{tx("Todos tus movimientos en un solo lugar.", "All your transactions in one place.")}</p></div>
