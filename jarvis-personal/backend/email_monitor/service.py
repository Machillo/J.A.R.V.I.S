...
def get_email_monitor_status() -> dict[str, Any]:
    ...
    return {
        "status": "OK",
        "owner_only": True,
        # The server-credential Owner Gmail reader is retired: the Owner connects
        # mailboxes through the standard per-account OAuth flow (/user-product/vip/gmail).
        "gmail_ready": False,
        "gmail_push_ready": False,
        "legacy_reader": "retired",
