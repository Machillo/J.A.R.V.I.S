...
export default function Investments() {
  ...
  return <section className="investments-page">
    <div className="investment-hero hud-panel">
      <div><span className="strategy-eyebrow">WEALTH BUILDING</span><h2>Inversiones</h2><p>JARVIS separa inversión de dinero libre y aumenta el aporte solo cuando tu flujo lo permite.</p></div>
    ...
    <div className="investment-kpi-grid">
      ...
      <div className="hud-card"><Banknote/><span>Capital aportado</span><strong>{usd(p.contributed_capital)}</strong><small>Dinero aportado históricamente</small></div>
    ...
    <div className="hud-panel"><div className="panel-heading"><div><span className="strategy-eyebrow">FONDEO INTELIGENTE</span><h3>Acumular antes de enviar</h3></div><ArrowDownToLine/></div>
      ...
      <small className="muted-text">IBKR: integración read-only preparada. Hasta conectarla, cartera, comisiones, dividendos e impuestos pueden venir de snapshots/manuales.</small>
    </div>
  </section>;
}
